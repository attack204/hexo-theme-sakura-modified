    ...
    function(e, t, n) {
        ...
        r.prototype.init = function(e) {
            ...
            try {
                ...
                var E = (0 == e.meta.length ? m: e.meta).map(function(e) {
                    ...
                    return m.indexOf(e) > -1 ? '<input name="' + e + '" placeholder="' + t.locale.head[e] + '"id="' + inputid + '" class="v' + e + ' vinput" type="' + n + '">': ""
                });
        ...
        r.prototype.bind = function(e) {
            ...
            Q = function() {
				...
				var name = document.getElementById("vinputnick").value;
                var email = document.getElementById("vinputmail").value;
