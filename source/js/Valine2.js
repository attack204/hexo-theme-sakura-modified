    ...
    function(e, t, n) {
        ...
        r.prototype.init = function(e) {
            ...
            try {
                ...
                y = e.path || y;
                var $ = Number(x || 10);
                if (e.pageSize = isNaN($) ? 10 : $ < 1 ? 10 : $, s.setOptions({
                ...
                if (! (z = z instanceof HTMLElement ? z: R[R.length - 1] || null)) return;
                t.el = z,
                ...
                t.alert = {
                    show: function(e) {
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), u.on("click", u.find(U, ".vcancel"),
                        function(e) {
                            t.alert.hide()
                        }), u.attr(U, "style", "display:block;"), e && e.type) {
        ...
        r.prototype.bind = function(e) {
            ...
            t.preview = {
                show: function() {
                    return v.comment && (t.emoji.hide(), u.attr(o, "v", 1), u.removeAttr(i, "v"), r.innerHTML = v.comment, u.attr(r, "style", "display:block"), T()),
                    t.preview
                },
                hide: function() {
            ...
            for (var S in _) _.hasOwnProperty(S) &&
            function() {
                var e = _[S],
                n = u.find(t.el, "." + S);
                k[e] = n,
            ...
            P = function(e) {
                ...
                }) : "" == v.comment ? void k.comment.focus() : (v.nick = v.nick || "Anonymous", void(t.notify || t.verify ? Q(N) : N()))
            },
            U = function() {
                var e = new AV.ACL;
            ...
            clearAttr: function(e) {
                ...
                function(t, r) {
                    ...
                    case "class":
                        ...
                        if (r.value.indexOf("at") > -1) return d.attr(e, "class", "at"),
                        !1
                    }
